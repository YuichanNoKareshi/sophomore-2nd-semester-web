...
class LoginView extends Component {
    ...
    handleSubmit = () => {
        ...
        fetch('http://localhost:8080/checkUser',opts)
            .then((response) => {
            ...
            .catch((error) => {
                console.log(error);
                this.alert('ERROR!','Username or password is wrong!');
            });
                    ...
                    <div className="login-container">
                        <div className="login-box">
                            ...
                            <div className="login-content">
                                ...
                                <br/>
                                <Input.Password size="large" placeholder="password" onChange={this.passwordChange}/>
                                <br/>
                                <br/>
