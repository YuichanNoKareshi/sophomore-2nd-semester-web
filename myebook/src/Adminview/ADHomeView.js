...
import ADHomeMain from "../Admincomponents/ADHomeMain";
import '../css/home.css'
import {Layout} from "antd";
const { Content } = Layout;

class ADHomeView extends React.Component{
    componentWillMount() {
            ...
            <Content>
                <layout className="site-layout-background" style={{ padding: '24px 0' }}>
                    ...
                    <div id="Contain">
                        ...
                        <div id="Contain-main"><ADHomeMain history={this.props.history} /></div>
                    </div>
                </layout>
            </Content>
        )
