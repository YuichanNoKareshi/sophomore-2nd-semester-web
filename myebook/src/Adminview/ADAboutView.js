...
import ADAboutMain from "../Admincomponents/ADAboutMain";
import '../css/home.css'
import {Layout} from "antd";
const { Content } = Layout;

class ADAboutView extends React.Component{
    componentWillMount() {
            ...
            <Content>
                <layout className="site-layout-background" style={{ padding: '24px 0' }}>
                    ...
                    <div id="Contain">
                        ...
                        <div id="Contain-main"><ADAboutMain history={this.props.history} /></div>
                    </div>
                </layout>
            </Content>
        )
